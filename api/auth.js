export default async function handler(req, res) {
    ...
    const GAS_WEBAPP_URL = process.env.GAS_AUTH_URL || 'https://script.google.com/macros/s/AKfycbwIG76-aZFRuE_9wbtAWKSQjGW7NelW35APqWr-SotTkJxdx_Fro-tlAt19WRZEq1wcsg/exec';
